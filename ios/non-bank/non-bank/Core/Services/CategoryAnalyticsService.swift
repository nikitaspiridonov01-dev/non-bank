...
// `InsightsPeriod` (the period enum + filter + formatter) moved to
// `InsightsPeriod.swift` so `CategoryAnalyticsService.swift` houses
// only the aggregation logic. No call-site changes — `InsightsPeriod`
// stays at file-scope visibility.
